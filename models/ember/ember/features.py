...
class SectionInfo(FeatureType):
    ...
    def process_raw_features(self, raw_obj):
        ...
        entry_name_hashed = FeatureHasher(50, input_type="string").transform([[str(raw_obj['entry'])]]).toarray()[0]
...
class HeaderFileInfo(FeatureType):
    ...
    def process_raw_features(self, raw_obj):
        return np.hstack([
            ...
            FeatureHasher(10, input_type="string").transform([[str(raw_obj['coff']['machine'])]]).toarray()[0],
            FeatureHasher(10, input_type="string").transform([[str(raw_obj['coff']['characteristics'])]]).toarray()[0],
            FeatureHasher(10, input_type="string").transform([[str(raw_obj['optional']['subsystem'])]]).toarray()[0],
            FeatureHasher(10, input_type="string").transform([[str(raw_obj['optional']['dll_characteristics'])]]).toarray()[0],
            FeatureHasher(10, input_type="string").transform([[str(raw_obj['optional']['magic'])]]).toarray()[0],
